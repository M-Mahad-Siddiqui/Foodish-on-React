...
function App() {
  ...
  const isFoodDetail = location.pathname.startsWith("/FoodDetail/"); // Check if the current path starts with "/FoodDetail/"
  ...
  return (
    <>
      ...
      <div className="app">
        ...
        {!isAdminRoute && !isFoodDetail && <Navbar setShowLogin={setShowLogin} />}
        <Routes>
      ...
      {!isAdminRoute && !isFoodDetail && <Footer />}
    </>
  );
}
